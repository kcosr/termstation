...
TermStation was not built with distribution in mind, so there is much work remaining to get it ready for general use. At this time, it's being made available so that those who are interested or following can try it out. Issues and PRs are welcome! Feel free to use Discussions to ask questions, or reach out to the developer @kcosr on X. Please see [CONTRIBUTING.md](CONTRIBUTING.md) for more information.
